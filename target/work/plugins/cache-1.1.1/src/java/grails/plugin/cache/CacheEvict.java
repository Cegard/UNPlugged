...
/**
 * Indicates that a method (or all methods on a class) trigger(s) a cache
...
public @interface CacheEvict {
	 ...
	 * invoked (default) or before. The latter causes the eviction to occur
	 * irrespective of the method outcome (whether it threw an exception or not)
