...
public class ClassUtils {
	 ...
	 * then this method will look for the corresponding field and return its
	 * value.
	 * 
	 * @param object
	 *            object to inspect
	 ...
	 */
	public static Object getPropertyOrFieldValue(Object object,
		...
		try {
			final Field field = ReflectionUtils.findField(objectClass,
					propertyOrFieldName);
			if (field != null) {
