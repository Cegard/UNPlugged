...
<body>
  <div class="body">
   	...
   	<param name='movie' value='http://10.203.72.164/swfs/SampleMediaPlayback.swf' /> 
   	<param name='quality' value='high' /> 
   	<param name='bgcolor' value='#000000' /> 
   	<param name='allowfullscreen' value='true' /> 
   	
   	<param name='flashvars' value= '&src=rtmp://10.203.72.164/live/livestream&autoHideControlBar=true&streamType=live&autoPlay=true&verbose=true'/>
   	<embed src='http://10.203.72.164/swfs/SampleMediaPlayback.swf' width='640' height='377' id='SampleMediaPlayback' quality='high' bgcolor='#000000' name='SampleMediaPlayback' allowfullscreen='true' pluginspage='http://www.adobe.com/go/getflashplayer' flashvars='&src=rtmp://localhost/live/livestream&autoHideControlBar=true&streamType=live&autoPlay=true&verbose=true' type='application/x-shockwave-flash'> </embed></object>
  </div>
</body>
</html>